            ...
            <div class="modal-body">
                ...
                <form id="editBookForm">
                    <div class="form-group">
                        <label for="editNaam">Title:</label>
                        <input type="text" class="form-control" id="editTitle" name="editNaam" required>
                    </div>
                    <div class="form-group">
                        <label for="editAdres">Author:</label>
                        <input type="text" class="form-control" id="editAuthor" name="editAdres" required>
                    </div>
                    <!-- Added a field for Quantity -->
                    <div class="form-group">
                        <label for="editTelefoonnummer">Quantity:</label>
                        <input type="number" class="form-control" id="editAantal" name="editTelefoonnummer" required>
                    </div>
            ...
            <div class="modal-body">
                ...
                <form id="createBookForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="createtelefoonnumer" name="telefoonnumer" required>
                    </div>
                    <!-- Submit button -->
